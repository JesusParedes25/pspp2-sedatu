 ...
 */
import { ChevronRight, ChevronDown, Layers, Zap, ListChecks } from 'lucide-react';
...
export default function NodoArbol({ nodo, tipo, nivel, expandidos, seleccionadoId, onToggle, onSelect, permisos, proyectoId, onCreado, mostrarToast }) {
